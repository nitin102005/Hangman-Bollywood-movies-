...
movies = ['Dilwale Dulhania Le Jayenge', 'Dhamaal', 'Dhoom', 'Kuch Kuch Hota Hai',
          'Kabhi Khushi Kabhie Gham', 'Sholay', 'Hera Pheri', 'Lagaan', 'Dil Chahta Hai', 'Go goa gone', 'Shaitaan','Sam Bahadur', 'Animal']
